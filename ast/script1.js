...
async function checkSignal() {
    ...
    const url = 'https://crash-gateway-cr.100hp.app/state?id_n=100hpgaming_astronaut&id_i=8';
...
function fetchDataAndUpdate() {
    const url = 'https://crash-gateway-cr.100hp.app/state?id_n=100hpgaming_astronaut';
    fetch(url, {
        headers: {
            'Authorization': getAuthorizationToken()
        }
